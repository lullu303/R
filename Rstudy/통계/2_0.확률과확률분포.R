...
# 기대값 분산 연습 
#####################################################
# 공정한 주사위 1개를 던져 윗면에 나타난 수에 100원을 곱한
# 금액을 주는 게임을 한다고 가정하자
# 이 게임을 하는 경우 한 게임당 평균적으로 얼마의 이득을 취할 수 있는가?
# 단 게임 한 판당 200원의 비용을 지불해야 한다.

# 기대값 : 확률변수 평균

# 공정한 주사위
# 주사위 1개를 던졌을 때 윗면에 나타난 수를 확률변수 
x_set <- c(1,2,3,4,5,6)
prob = 1/6

# 확률분포
data.frame(x_set, prob)
# x_set      prob
# 1     1 0.1666667
# 2     2 0.1666667
# 3     3 0.1666667
...
# 게임에서 나타나는 확률변수 y
# y와 x의 관계 : y = x * 100 -200
y_set = 100 * x_set -200
y_set

# 확률변수 y의 각 값의 확률은 1/6
prob = 1/6

# 확률분포
data.frame(y_set, prob)
...
# 어떤 축구팀이 한 시가느 38주 중에 매주 1~2회의 경기 진행
# 주당 1회 경기 : 0.5, 2회 경기 : 0.3, 경기가 없는 주간 : 0.2
# 이 팀은 평균적으로 매주 몇 경기를 수행하여야 하는가?
