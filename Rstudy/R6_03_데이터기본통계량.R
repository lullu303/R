...
# quantile(데이터, probs=) # 특정 분위수만 추출할 수 있음
...
f_test <- freq(exdata1$AREA, plot=F) # 행렬구조 반환
f_test
class(f_test)
...
###################################
# 히스토그램 : 도수분포 상태를 기둥모양으로 표현한 그래프
# 구간별 관측치의 분포상태를 빠르게 확인가능하다
