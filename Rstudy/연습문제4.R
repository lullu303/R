...
# srch함수에 df s를 전달하면 함수 내부의 for문의 실행 횟수는?
...
# y축 생성 : ylim은 plot 생성 시 설정한 ylim과 일치시켜야 한다
axis(2,ylim=c(0,8))
title(main="학점별 학생수", col.main='red')
title(xlab= "학점(점)", col.lab='black')
title(ylab= "학생 수 (명)", col.lab="blue")
}
...
title(main="연령대별 tv, 스마트폰 이용률", col.main='green')
# 범례
